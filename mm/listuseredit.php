...
<head>
  ...
  <!-- css saya -->
  <link rel="stylesheet" href="../anjir.css">
</head>
      ...
      <div class="container">
        ...
        <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
          <li class="nav-item NB">
            <a href="daftarpengguna.php" class="teks">List User</a>
          </li>
          <li class="nav-item NB">
            <a href="formuser.php" class="teks">Form User</a>
          </li>
          <li class="nav-item NB">
            <a href="daftarmenu.php" class="teks">List Menu</a>
          </li>
          <li class="nav-item NB">
            <a href="formmenu.php" class="teks">Form Menu</a>
          </li>
          <li class="nav-item login ml-4">
            <a class="btn btn-sm masuk" href="masuk.php" role="button">Keluar</a>
          </li>
        </ul>
      </div>
    </nav>
